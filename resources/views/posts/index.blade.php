              ...
              <tbody>
                @forelse ($japanese as $post)
                  <tr>
                    ...
                    <th class="title">
                      <a href="/posts/{{ $post->random_string . '?subject=japanese' }}">
                        <p>{{ $post->title  }}</p>
                      </a>
                    </th>
                    <th class="date">
              ...
              <tbody>
                @forelse ($math as $post)
                  <tr>
                    ...
                    <th class="title">
                      <a href="/posts/{{ $post->random_string . '?subject=math' }}">
                        <p>{{ $post->title  }}</p>
                      </a>
                    </th>
                    <th class="date">
              ...
              <tbody>
                @forelse ($english as $post)
                  <tr>
                    ...
                    <th class="title">
                      <a href="/posts/{{ $post->random_string . '?subject=english'}}">
                        <p>{{ $post->title  }}</p>
                      </a>
                    </th>
                    <th class="date">
              ...
              <tbody>
                @forelse ($science as $post)
                  <tr>
                    ...
                    <th class="title">
                      <a href="/posts/{{ $post->random_string . '?subject=science' }}">
                        <p>{{ $post->title  }}</p>
                      </a>
                    </th>
                    <th class="date">
              ...
              <tbody>
                @forelse ($social as $post)
                  <tr>
                    ...
                    <th class="title">
                      <a href="/posts/{{ $post->random_string . '?subject=social' }}">
                        <p>{{ $post->title  }}</p>
                      </a>
                    </th>
                    <th class="date">
            ...
            <table class="subject-table">
              ...
              @forelse ($posts_etc as $post)
                <tr>
                  ...
                  <th class="title">
                    <a href="/posts/{{ $post->random_string . '?subject=etc' }}">
                      <p>{{ $post->title  }}</p>
                    </a>
                  </th>
                  <th class="date">
